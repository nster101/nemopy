...
try:
    ...
    class _st_stub:
        def data(self): return _or_stub
    st = _st_stub()
    class _hynp_stub:
        def arrays(self, **kw): return _or_stub
        def integer_dtypes(self): return _or_stub
        def floating_dtypes(self): return _or_stub
        def array_shapes(self): return _or_stub
    hynp = _hynp_stub()
...
class TestTypes:
    ...
    @pytest.mark.xfail(getattr(np, '_get_promotion_state', lambda: "legacy")() != "legacy",
